...
public class SpecialActivity2 extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		item = (ArticleItem) intent.getSerializableExtra("SpecialActivity");
		initView();
		getdata();
	}
	...
	private void setListData(ArticleItem data) {
		ArticleItem datas =data;
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				ArticleItem item2 = articleAdapter.getItem(position-1);
