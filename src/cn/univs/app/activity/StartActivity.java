...
public class StartActivity extends FragmentActivity {
    ...
    private void init_Data() {
        ...
        try {
            boolean1 = SharedPMananger.getBoolean(SharedPMananger.FRIST_APP, false);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (!boolean1) {
    ...
    /*private void aaa() {
        ...
        Splash splash = (Splash) ParseUtils.Gson2Object(content, tp);
        try {
        ...
        if (splash != null && splash.isState()) {
            ...
            image = "http://www.gzhu.edu.cn/images/index/main_img/1.jpg";//开头图片zhz,，不上网load图
            if (isload) {
